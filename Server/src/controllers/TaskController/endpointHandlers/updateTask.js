...
var updateTask = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var taskId, isCreator, data, filteredData, task, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, prisma_client_1.prisma.task.update({
                        where: { id: taskId },
                        data: __assign({}, data),
                    })];
            case 2:
                task = _a.sent();
                return [2 /*return*/, res.status(200).json({ task: task, message: "Успешно обновлено!" })];
            case 3:
                error_1 = _a.sent();
                return [2 /*return*/, res.status(500).json({ error: "Ошибка при обновлении задачи" })];
